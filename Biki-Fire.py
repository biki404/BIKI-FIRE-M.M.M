...
def main_apv():
    ...
    try:
        ...
        tks = 'Dear%20BikiSir,%20Please%20Approved%20My%20Token%20To%20Premium%20% 20% 20%20%20My%20%20Key%20%20:%20'+ak+''+myid+''+imt

        os.system('am start https://wa.me/+919957975493?text=' + tks)

        

    r1=requests.get("https://pastebin.com/raw/J1W3mNL9").text
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : facebook.com/bikiterabap

    Connect  : +919957975493
...
def R():
			...
			print ("\033[1m [!] Tool    : BIKI MAHAMOOD")
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workers=45) as ssbworld:
